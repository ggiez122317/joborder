                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="City" data-field="cName">
                                    <span>City</span>
                                </a>
                            </th>
                            ...
                            for (key in res.items.records) {
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        ...
                                        <td class="text-start">${res.items.records[key].cName}</td>
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].barangayID}/'">
                                                    <span>
