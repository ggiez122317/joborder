                    ...
                    if (res.status == 200) {
                        ...
                        if (res.items.provinces.length > 0) {
                            for (key in res.items.provinces) {
                                html += `<option value="${res.items.provinces[key].provinceID}" ${res.items.provinces[key].provinceID==res.items.row.provinceID?'selected':''}>${res.items.provinces[key].name}</option>`
                            }
                        }
