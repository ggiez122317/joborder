                        ...
                        if (res.items.records.length > 0) {
                            ...
                            for (key in res.items.records) {
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        <td class="text-start">${res.items.records[key].date}</td>
                                        <td class="text-start">${res.items.records[key].employee}</td>
                                        <td class="text-start">${res.items.records[key].amArrival}</td>
                                        <td class="text-start">${res.items.records[key].amDeparture}</td>
                                        <td class="text-start">${res.items.records[key].pmArrival}</td>
                                        <td class="text-start">${res.items.records[key].pmDeparture}</td>
                                        <td class="text-start">${res.items.records[key].undertimeHour}</td>
                                        <td class="text-start">${res.items.records[key].undertimeMinute}</td>
                                    </tr>
                                `)
                            }
                        }
