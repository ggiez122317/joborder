...
@section('content')
    <div class="card">
        ...
        <form id="formView" class="card-body p-2">
            ...
            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Show in report</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="showInReport" style="background: #e3e3e3;" readonly>
                </div>
            </div>
            ...
            apiCall(`/api/{{ "$controller/$id" }}/`, 'GET', null, 
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $(`#${formID} input[name="showInReport"]`).val(res.items.row.showInReport?'Yes':'No')
