                        ...
                        if (res.items.records.length > 0) {
                            for (key in res.items.records) {
                                tblData.push({
                                    ...
                                    "code"     : res.items.records[key].code, 
                                    "employee"     : res.items.records[key].employee, 
                                    "destination"     : res.items.records[key].destination, 
                                    "purpose"     : res.items.records[key].purpose, 
                                    "status"     : statusNames[res.items.records[key].status], 
                                })
                            }
                        }
