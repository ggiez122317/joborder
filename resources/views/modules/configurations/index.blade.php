                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Value" data-field="value">
                                    <span>Value</span>
                                </a>
                            </th>
                            <th class="text-start">
            ...
            apiCall(`/api/{{ "$controller" }}/?${getFilterItems()}`, 'GET', null, 
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        // body
                        $(`#${formID} table tbody`).html('<tr><td class="text-start" colspan="3">No Record Found</td></tr>')
                            ...
                            for (key in res.items.records) {
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        ...
                                        <td class="text-start">${res.items.records[key].value}</td>
                                        <td class="text-start">${res.items.records[key].remarks}</td>
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].configurationID}/'">
                                                    <span>
