            ...
            <div class="card-body p-2">
                ...
                <div class="row g-2 mb-2">
                    <div class="col-12 col-md-2">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Name" style="background: #e3e3e3;" readonly>
                    </div>
                    <div class="col-12 col-md-5">
                        <label class="form-label">Value <span class="text-danger">*</span></label>
                        <textarea name="value" class="form-control" rows="3" placeholder="Value"></textarea>
                    </div>
                    <div class="col-12 col-md-5">
                        <label class="form-label">Remarks </label>
                        <textarea name="remarks" class="form-control" rows="3" placeholder="Remarks" style="background: #e3e3e3;" readonly></textarea>
                    </div>
                </div>
            ...
            apiCall(`/api/{{ "$controller" }}/page-put/{{ "$id" }}/`, 'GET', null, 
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $(`#${formID} textarea[name="value"]`).val(res.items.row.value)
