...
@section('content')
    <div class="card">
        ...
        <form id="formView" class="card-body p-2">
            ...
            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Job Position Code</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Job Position Name</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Immediate Superior</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="superior" style="background: #e3e3e3;" readonly>
                </div>
            </div>
            ...
            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Is Mayor</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="isMayor" style="background: #e3e3e3;" readonly>
                </div>
            </div>

            <div class="row mb-2">
                <label class="col-sm-2 col-form-label">Is HR Head</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="isHrHead" style="background: #e3e3e3;" readonly>
                </div>
            </div>
            ...
            apiCall(`/api/{{ "$controller/$id" }}/`, 'GET', null, 
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $(`#${formID} input[name="superior"]`).val(res.items.row.superior)
                        $(`#${formID} input[name="office"]`).val(res.items.row.office)
                        $(`#${formID} input[name="isMayor"]`).val(res.items.row.isMayor?'Yes':'No')
                        $(`#${formID} input[name="isHrHead"]`).val(res.items.row.isHrHead?'Yes':'No')
