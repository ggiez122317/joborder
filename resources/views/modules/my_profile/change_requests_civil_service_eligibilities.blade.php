...
@section('scripts')
    <script>
        ...
        function getRow(userPdsChangeRequestID)
        {
            ...
            apiCall(`/api/{{ "$controller" }}/changes-civil-service-eligibility/${userPdsChangeRequestID}/`, 'GET', null, 
                // beforesend
                function() {
        ...
        function getItems()
        {
            ...
            apiCall(`/api/{{ "$controller" }}/changes-civil-service-eligibilities/`, 'GET', null, 
                // beforesend
                function() {
