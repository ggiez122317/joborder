...
@section('modals')
    <div class="modal fade" id="modalViewChangeRequest" tabindex="-1" aria-labelledby="modalViewChangeRequestLabel" aria-hidden="true">
...
@section('scripts')
    <script>
        ...
        function getRow(userPdsChangeRequestID)
        {
            ...
            apiCall(`/api/{{ "$controller" }}/changes-personal-information/${userPdsChangeRequestID}/`, 'GET', null, 
                // beforesend
                function() {
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        if (res.items.records.length > 0) {
                            ...
                            const statusNames   = ['Denied', 'Pending', 'Approved', 'Administered']
                            const status_colors = ['danger', 'info', 'success', 'primary']
                            ...
                            for (key in res.items.records) {
                                ...
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        <td class="text-start">${res.items.records[key].label}</td>
        ...
        function getItems()
        {
            ...
            apiCall(`/api/{{ "$controller" }}/changes-personal-informations/`, 'GET', null, 
                // beforesend
                function() {
