                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Inserted By" data-field="employee">
                                    <span>Inserted By</span>
                                </a>
                            </th>
                            <th class="text-start">
                        ...
                        <tr valign="middle">
                            <th class="text-center">
                                <input type="dateInserted" class="form-control" name="dateInserted" >
                            </th>
                            <th class="text-start">
                            ...
                            <th class="text-start">
                                <select name="officeID" class="form-control m-auto" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-center">
                    ...
                    if (res.status == 200) {
                        ...
                        if (res.items.offices.length > 0) {
                            ...
                            for (key in res.items.offices) {
                                html += `<option value="${res.items.offices[key].officeID}" ${res.items.offices[key].officeID==res.items.filters.officeID?'selected':''}>${res.items.offices[key].code} - ${res.items.offices[key].name}</option>`
                            }
                        }
                        ...
                        if (res.items.records.length > 0) {
                            ...
                            const statuses      = ['Cancelled', 'New', 'Released', 'Finalized']
                            const status_colors = ['danger', 'info', 'primary', 'done']
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].biometricLogID}/'">
                                                    <span>
