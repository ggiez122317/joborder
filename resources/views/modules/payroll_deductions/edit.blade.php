                    ...
                    <div class="col-12">
                        <div class="d-flex">
                            <div class="form-check">
                                <input class="form-check-input" name="showInReport" type="checkbox" value="1" id="showInReport">
            ...
            apiCall(`/api/{{ "$controller" }}/page-put/{{ "$id" }}/`, 'GET', null, 
                ...
                function(res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $(`#${formID} input[name="showInReport"]`).prop('checked', res.items.row.showInReport?true:false)
