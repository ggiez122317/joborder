            ...
            <div class="card-body p-2">
                ...
                <div class="row g-2 mb-2">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="text" name="office" class="form-control" style="background: #e3e3e3;" readonly>
                    </div>
                    <div class="col-12 col-md-3">
                        <label class="form-label">Position</label>
                        <input type="text" name="position" class="form-control" style="background: #e3e3e3;" readonly>
                    </div>
                </div>
