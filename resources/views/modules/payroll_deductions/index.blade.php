            ...
            <div class="table-responsive text-nowrap">
                <table class="table mb-0">
                    <thead>
                        <tr>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Employee" data-field="user">
                                    <span>Employee</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-end align-items-center filterSort" data-label="Deduction" data-field="amount">
                                    <span>Deduction</span>
                                </a>
                            </th>
                        ...
                        <tr valign="middle">
                            <th class="text-center">
                                <input type="text" class="form-control" name="lname" placeholder="Employee Last Name" >
                            </th>
                            ...
                            for (key in res.items.records) {
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        ...
                                        <td class="text-end">${res.items.records[key].amount}</td>
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].userPayrollDeductionID}/'">
                                                    <span>
