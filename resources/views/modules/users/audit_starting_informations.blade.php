...
@section('scripts')
    <script>
        ...
        function getAudit()
        {
            ...
            apiCall(`/api/{{ "$controller/page-audit-starting-information/$id" }}/`, 'GET', null, 
                // beforesend
                function() {
                            ...
                            for (key in res.items.AuditLogDetails) {
                                $('#tblAuditLogDetail').append(`
                                    <tr>
                                        ...
                                        <td class="text-start">${res.items.AuditLogDetails[key].valueOld}</td>
                                        <td class="text-start">${res.items.AuditLogDetails[key].valueNew}</td>
                                    </tr>
                                `)
                            }
                        }
