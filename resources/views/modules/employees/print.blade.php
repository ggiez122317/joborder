                        ...
                        if (res.items.records.length > 0) {
                            for (key in res.items.records) {
                                tblData.push({
                                    ...
                                    "lname"     : res.items.records[key].lname, 
                                    "fname"     : res.items.records[key].fname, 
                                    "mname"     : res.items.records[key].mname, 
                                    "gender"    : res.items.records[key].gender, 
                                    "birthDate" : res.items.records[key].birthDate, 
                                })
                            }
                        }
