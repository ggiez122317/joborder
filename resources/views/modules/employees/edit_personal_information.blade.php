...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/vendor/libs/cropperjs/dist/cropper.min.css') }}" />
@endsection
...
@section('scripts')
    <script src="{{ asset('assets/vendor/libs/cropperjs/dist/cropper.min.js') }}"></script>
    <script>
