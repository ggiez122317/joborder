                    ...
                    if (res.status == 200) {
                        ...
                        if (res.items.records.length > 0) {
                            for (key in res.items.records) {
                                tblData.push({
                                    "dateAppointed" : res.items.records[key].dateAppointed, 
                                    "idNumber"      : res.items.records[key].idNumber, 
                                    "employee"      : res.items.records[key].employee, 
                                    "office"        : res.items.records[key].office, 
                                    "jobPosition"   : res.items.records[key].jobPosition, 
                                    "salaryMonthly" : res.items.records[key].salaryMonthly, 
                                    "type"          : res.items.records[key].type, 
                                    "status"        : res.items.records[key].status, 
                                })
                            }
                        }
