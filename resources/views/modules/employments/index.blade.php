            ...
            <div class="table-responsive text-nowrap">
                <table class="table mb-0">
                    <thead>
                        <tr>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Date Appointed" data-field="dateAppointed">
                                    <span>Date Appointed</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Employee ID" data-field="idNumber">
                            ...
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Office" data-field="office">
                                    <span>Office</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Position" data-field="jobPosition">
                                    <span>Position</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Salary/mo" data-field="salary">
                                    <span>Salary/mo</span>
                                </a>
                            </th>
                            <th class="text-start d-none">
                                <a href="javascript:void(0);" class="d-flex justify-content-center align-items-center filterSort" data-label="Type" data-field="userEmploymentType">
                                    <span>Type</span>
                                </a>
                            </th>
                            <th class="text-start">
                        ...
                        <tr valign="middle">
                            <th class="text-center">
                                <input type="date" class="form-control form-control-sm" name="dateAppointed" >
                            </th>
                            <th class="text-center">
                            ...
                            <th class="text-center">
                                <select name="officeID" class="form-control form-control-sm m-auto" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-center">
                                <select name="jobPositionID" class="form-control form-control-sm m-auto" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-center"></th>
                            <th class="text-center d-none">
                                <select name="userEmploymentTypeID" class="form-control form-control-sm m-auto" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-center">
                                <select name="status" class="form-control form-control-sm m-auto" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-center">
                    ...
                    if (res.status == 200) {
                        ...
                        // if (res.items.hasButtonPrint) {
                            $('.divBtnNewRecord').html(`
                                <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='{{ url("/$controller/new/0/") }}'">
                                    <span>
                                        <i class="bx bx-plus me-sm-1"></i> 
                        ...
                        /** filter fields */ 
                        $(`#${formID} input[name="idNumber"]`).val(`${res.items.filters.idNumber}`)
                        $(`#${formID} input[name="employee"]`).val(`${res.items.filters.employee}`)
                        ...
                        if (res.items.offices.length > 0) {
                            ...
                            for (key in res.items.offices) {
                                html += `<option value="${res.items.offices[key].officeID}" ${res.items.offices[key].officeID==res.items.filters.officeID?'selected':''}>${res.items.offices[key].code}</option>`
                            }
                        }
                        ...
                        if (res.items.JobPositions.length > 0) {
                            ...
                            for (key in res.items.JobPositions) {
                                html += `<option value="${res.items.JobPositions[key].jobPositionID}" ${res.items.JobPositions[key].jobPositionID==res.items.filters.jobPositionID?'selected':''}>${res.items.JobPositions[key].code}</option>`
                            }
                        }
                        ...
                        if (res.items.user_employment_types.length > 0) {
                            ...
                            for (key in res.items.user_employment_types) {
                                html += `<option value="${res.items.user_employment_types[key].userEmploymentTypeID}" ${res.items.user_employment_types[key].userEmploymentTypeID==res.items.filters.userEmploymentTypeID?'selected':''}>${res.items.user_employment_types[key].name}</option>`
                            }
                        }
                        ...
                        // body
                        $(`#${formID} table tbody`).html('<tr><td class="text-start" colspan="9">No Record Found</td></tr>')
                        if (res.items.records.length > 0) {
                            ...
                            for (key in res.items.records) {
                                ...
                                $(`#${formID} table tbody`).append(`
                                    <tr>
                                        <td class="text-center">${res.items.records[key].dateAppointed}</td>
                                        <td class="text-center">${res.items.records[key].idNumber}</td>
                                        ...
                                        <td class="text-center">${res.items.records[key].salaryBasic}</td>
                                        <td class="text-center d-none">${res.items.records[key].uetName}</td>
                                        <td class="text-center text-${statusColors[res.items.records[key].status]}">${statusNames[res.items.records[key].status]}</td>
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].userEmploymentID}/'">
                                                    <span>
