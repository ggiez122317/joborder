                ...
                <table class="table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Employee" data-field="code">
                                    <span>Employee</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Leave Type" data-field="destination">
                                    <span>Leave Type</span>
                                </a>
                            </th>
                            <th class="text-start">
                                <a href="javascript:void(0);" class="d-flex align-items-center filterSort" data-label="Leave Days" data-field="destination">
                        ...
                        <tr valign="middle d-none">
                            <th class="text-center">
                                <input type="text" class="form-control flatpickrDateRange" name="dateInserted" >
                            </th>
                            <th class="text-start">
                                <select name="" class="form-control select2" style="width: auto;">
                                    <option value="">&nbsp;</option>
                                </select>
                            </th>
                            <th class="text-start">
                    ...
                    if (res.status == 200) {
                        ...
                        // if (res.items.hasButtonPrint) {
                            $('.print-travel-report').html(`
                                <a class="dropdown-item" onclick="printTravelReport()" href="javascript:void(0);">Travel Report</a>
                            `)
                        // }
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ${res.items.hasButtonView?`
                                                <button type="button" class="btn btn-info btn-sm" onclick="window.location.href='{{ url("/$controller/view") }}/${res.items.records[key].leaveApplicationID}/'" style="position: relative;">
