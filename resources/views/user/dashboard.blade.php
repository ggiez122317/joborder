...
@section('page_subtitle', 'LGU Trento — PDS Management · Self-Service portal')

@section('page_actions')
    @if ($hasPds)
        <a href="{{ route('user.pds.form') }}" class="dash-primary-btn">Edit My PDS</a>
    @else
        <a href="{{ route('user.pds.form') }}" class="dash-primary-btn">Start My PDS</a>
    @endif
@endsection
...
@section('content')
    ...
    <style>
        ...
        .dash-section-label:first-of-type {
            margin-top: 0;
        }
    ...
    <div class="dash-shell">
        ...
        <div class="dash-section-label">Data quality & Intake</div>
        ...
        <div class="dash-section-label">Analytics & Distributions</div>
                    ...
                    <table class="dash-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4">
                                        <div class="dash-empty" style="min-height:120px">No PDS records encoded yet.</div>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
